...
<script lang="ts">
  ...
  import graniteAttribution from "$lib/assets/licenses/ATTRIBUTION-IBM-GRANITE.md?raw";
  import apacheLicense from "$lib/assets/licenses/LICENSE-APACHE-2.0.txt?raw";
  ...
  onMount(() => {
    ...
    licenses = [
      {
        name: "ChaosNexus Tuned v1 + IBM Granite (model weights)",
        version: "ChaosNexus_Tuned_v1-GGUF",
        repository: "https://huggingface.co/TunedChaos/ChaosNexus_Tuned_v1-GGUF",
        license: "AGPL-3.0-or-later (packaging); Apache-2.0 (IBM Granite base)",
        text: graniteAttribution + "\n\n---\n\n" + apacheLicense,
        source: "Third-party model",
      },
      ...combined,
    ];
...
{#if isOpen}
  ...
  >
    ...
    >
      ...
      <p class="theme-text-muted text-sm">ChaosNexus Forge is a product of Tuned Chaos &copy; 2026</p>
