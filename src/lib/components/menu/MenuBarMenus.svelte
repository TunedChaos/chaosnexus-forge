...
<script lang="ts">
  ...
  let {
    ...
    handleAbout,
    handleSettings,
    handleToggleAgentChat,
    handleToggleAgentChatEnabled,
  }: {
    ...
    handleAbout: () => void;
    handleSettings: () => void;
    handleToggleAgentChat: () => void;
    handleToggleAgentChatEnabled: () => void;
  } = $props();
</script>
  ...
  <div class="relative h-full">
    ...
    {#if activeMenu === "view"}
      ...
      >
        ...
        >
          Agent <span class:underline={keyboardNavigation}>C</span>hat
        </MenuDropdownButton>
        <MenuDropdownButton
          onclick={() => {
            handleToggleAgentChatEnabled();
