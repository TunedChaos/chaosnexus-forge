...
pub struct AppSettings {
    ...
    /// Absolute path to the ChaosNexus Crucible executable.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub crucible_bin: Option<String>,
    /// Crucible HTTP listen port (default 8080).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub crucible_port: Option<u16>,
    /// Crucible inference backend (`candle`, `colibri`, or `stub`).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub crucible_backend: Option<String>,
    /// Hugging Face Hub token for Crucible model downloads (injected as HF_TOKEN).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub hf_token: Option<String>,
    /// Active Crucible Hub model id (default Tuned GGUF).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub crucible_model_id: Option<String>,
    /// Optional explicit `.gguf` filename within the Hub repo.
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub crucible_gguf_file: Option<String>,
    /// User accepted Apache-2.0 terms for downloading IBM Granite weights (Path 2).
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub granite_apache_accepted: Option<bool>,
}
...
impl AppSettings {
    ...
    pub fn normalized(mut self) -> Self {
        ...
        self.crucible_bin = non_empty(self.crucible_bin);
        self.crucible_backend = non_empty(self.crucible_backend);
        self.hf_token = non_empty(self.hf_token);
        self.crucible_model_id = non_empty(self.crucible_model_id);
        self.crucible_gguf_file = non_empty(self.crucible_gguf_file);
        self
    }
}
