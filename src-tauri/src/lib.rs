...
pub mod crucible_supervisor;
pub mod anvil_mcp;
pub mod skills_rules;
pub mod llm_bridge;
pub mod cli_agent_bridge;
use crucible_supervisor::CrucibleSupervisor;
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .manage(CrucibleSupervisor::default())
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            crucible_bridge::crucible_sessions_list,
            crucible_bridge::crucible_sessions_create,
            crucible_bridge::crucible_sessions_get,
            crucible_bridge::crucible_sessions_update,
            crucible_bridge::crucible_sessions_delete,
            crucible_bridge::crucible_models_status,
            crucible_bridge::crucible_models_pull,
            crucible_bridge::crucible_models_list,
            crucible_supervisor::crucible_start,
            crucible_supervisor::crucible_stop,
            crucible_supervisor::crucible_restart,
            crucible_supervisor::crucible_status,
            anvil_mcp::anvil_mcp_list,
            anvil_mcp::anvil_mcp_upsert,
            anvil_mcp::anvil_mcp_remove,
            anvil_mcp::anvil_mcp_config_path,
            anvil_mcp::anvil_mcp_apply_restart,
            skills_rules::skills_rules_list,
            skills_rules::skills_rules_read,
            skills_rules::skills_rules_write,
            skills_rules::skills_rules_delete,
            ...
            suite_paths::get_suite_scripts_dir,
            suite_paths::get_suite_plugins_dir,
            suite_paths::resolve_codex_bin
        ])
